...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://api.edamam.com/api/recipes/v2?type=public&app_id=5b31234f&app_key=2381d9ca3c66cd815d5f49c76458a396&diet=balanced&cuisineType=British&mealType=Lunch&field=label&field=image&field=source&field=ingredientLines&field=ingredients"
      )
      .then((response) => {
